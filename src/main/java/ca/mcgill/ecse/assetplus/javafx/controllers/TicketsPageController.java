...
public class TicketsPageController {
  ...
  public void refresh() {
    ...
    fixedByEmail.setCellValueFactory(new PropertyValueFactory<TOMaintenanceTicket, String>("fixedByEmail"));
    ...
    expectLifeSpanInDays.setCellValueFactory(new PropertyValueFactory<TOMaintenanceTicket, Integer>("expectLifeSpanInDays"));
    notes.setCellValueFactory(new PropertyValueFactory<TOMaintenanceTicket, List<TOMaintenanceNote>>("notes"));
